...
public class StatusBarManager {
    ...
    @ColorInt
    public  static  final int ASC=0x3C3DD5;
    /**
     * 仅仅让状态栏透明，布局类容位于状态下方
     */
    public static void translucentStatusBar(Activity activity) {
        ...
        if (SystemFacade.hasKitKat() && !SystemFacade.hasLollipop()) {
            ...
            //在 4.4 api 19 和 API 20 添加FLAG_TRANSLUCENT_STATUS 是让系统状态栏为透明，同时系统会自动设置View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE
            //所以布局延伸到了状态下面
            ...
            //设置状态栏为透明
            window.setStatusBarColor(StatusBarManager.ASC);
    ...
    public static void immersive(Activity activity) {
        ...
        if (SystemFacade.hasKitKat() && !SystemFacade.hasLollipop()) {
            ...
            Window window = activity.getWindow();
            //在 4.4 api 19 和 API 20 添加FLAG_TRANSLUCENT_STATUS 是让系统状态栏为透明，同时系统会制动设置View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE
            //所以布局延伸到了状态下面
    ...
    private static void createOrChangeMockStatusBarColor(Activity activity, int color) {
        ...
        if (fakeView != null) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, SystemFacade.getScreenHeight(activity));
